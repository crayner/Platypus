...
class DaysTimesHelper
{
	...
	/**
	 * @return DaysTimesHelper
	 */
	private function loadDaysTimes(): DaysTimesHelper
	{
	 ...
	 * @return DaysTimesHelper
	 */
	public function setDay(Day $day): DaysTimesHelper
	{
		$this->day = $day;
	 ...
	 * @return DaysTimesHelper
	 */
	public function setTime(SchoolTime $time): DaysTimesHelper
	{
		$this->time = $time;
	...
	public function saveDaysTimes(FormInterface $form): DaysTimesHelper
	{
		$data = $form->getData();
