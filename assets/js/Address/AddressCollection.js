        ...
        <div className="col-12 text-justify">
          <div className="input-group input-group-sm">
            ...
            <span className="input-group-append">
              <button className="btn btn-success" type="button" onClick={() => newAddress()} title={translateMessage(translations, 'address.button.add')}><FontAwesomeIcon icon={faPlusCircle} fixedWidth /></button>
            </span>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-12">
          <div
            className="small"
            style={{
              maxHeight: '200px', overflowY: 'scroll', overflowX: 'hidden', cursor: 'pointer',
            }}
          >
            {options}
          </div>
